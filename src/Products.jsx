              ...
              <div className="hero bg-white lg:w-[1280px] md:w-[800px] rounded-2xl  w-[300px] ml-[12%]">
                <div className="flex gap-6  flex-col  justify-center items-center md:flex-row-reverse p-6">
                  ...
                  <div className="text-center lg:text-left lg:pt-7 ">
                    ...
                    <div className="text-2xl font-medium text-gray-500 grid gap-4 mt-4"></div>

                    <div className="grid gap-4">
                      <h4 className="text-3xl mt-3 font-bold text-black">
                        Rating
                      </h4>
                      ...
                      <div className=" flex gap-4">
                        <button className=" flex justify-center gap-2 items-center py-3 hover:text-black text-white text-xl font-semibold px-6 bg-[#9538E2] border-2 rounded-full border-solid border-gray-600">
                          Add To Card
                          <img
                        ...
                        <button className=" border-2 rounded-full border-solid border-gray-600 p-2 hover:bg-[#9538E2] ">
                          <img
